        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, auth_service_1.authService.register(req.body)];
                    case 1:
                        usuario = _a.sent();
                        res.status(201).json({
                            success: true,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, auth_service_1.authService.login(req.body)];
                    case 1:
                        tokens = _a.sent();
                        res.json({
                            success: true,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, auth_service_1.authService.logout(req.body.refreshToken)];
                    case 1:
                        _a.sent();
                        res.json({
                            success: true,
